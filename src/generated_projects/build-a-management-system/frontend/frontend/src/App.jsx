...
const blueprint = {
  "Executive Summary": "This blueprint outlines the development of a state-of-the-art solution for: 'build a management system'. Designed with modern scalability, security, and modularity in mind, the system leverages FastAPI, React, TailwindCSS and a PostgreSQL database to deliver a seamless user experience.",
  ...
  "Frontend Components": "Interactive UI components built to support 'build a management system'. Includes: Dashboard, User Settings, Goal Management Panel, and real-time visualization widgets.",
